...
<head>
    ...
    <!-- //Meta tag Keywords -->
    <!-- Custom-Files -->
    <link href="<c:url value="../css/web/bootstrap.css"/> " rel="stylesheet" type="text/css" media="all" />
    <!-- Bootstrap css -->
    <link href="<c:url value="../css/web/style.css"/> " rel="stylesheet" type="text/css" media="all" />
    <!-- Main css -->
    <link rel="stylesheet" href="../css/web/fontawesome-all.css">
    <!-- Font-Awesome-Icons-CSS -->
    <link href="<c:url value="../css/web/popuo-box.css"/> " rel="stylesheet" type="text/css" media="all" />
    <!-- pop-up-box -->
    <link href="<c:url value="../css/web/menu.css"/> " rel="stylesheet" type="text/css" media="all" />
    <!-- menu style -->
    <!-- //Custom-Files -->
